...
app.get("/v1/explorers/usernames/:mission", (request, response) => {
    const mission = request.params.mission;
    const explorersnamesInMission = ExplorerController.getExplorersUsernamesByMission(mission)
    response.json({mission: request.params.mission, names: explorersnamesInMission});
});
